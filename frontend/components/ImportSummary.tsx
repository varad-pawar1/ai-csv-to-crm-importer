...
export function ImportSummary({ jobId, results }: ImportSummaryProps) {
    ...
    <div className="space-y-6">
      <Card>
        ...
        <div className="flex flex-wrap gap-3">
          <a href={getExportUrl(jobId, 'csv')} download className="inline-flex">
            <Button type="button">
              <Download className="h-4 w-4" />
              Export CSV
            </Button>
          </a>
          <a href={getExportUrl(jobId, 'json')} download className="inline-flex">
